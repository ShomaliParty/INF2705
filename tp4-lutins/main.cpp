...
void calculerPhysique( )
{
    ...
    if ( Etat::enmouvement )
    {
        ...
        // se préparer
        // glBindBuffer( ... );
        glBindBuffer( GL_ARRAY_BUFFER, vbo[0] ); // On utilise les valeurs courantes
...
void afficherModele()
{
    ...
    switch ( Etat::texnumero ) // 0-aucune, 1-flocon, 2-oiseau
    {
    default: glBindTexture( GL_TEXTURE_2D, 0 ); break;
    case 1: glBindTexture( GL_TEXTURE_2D, Etat::textureFLOCON ); break;
...
void FenetreTP::clavier( TP_touche touche )
{
    ...
    case TP_t: // Changer la texture utilisée: 0-aucune, 1-flocon, 2-oiseau
...
enum typedeplace { deplaceCam, deplacePuits };
typedeplace deplace = deplaceCam;
