...
public:
    ...
    void initialiserGraphique()
    {
        ...
        if ((locillumination = glGetUniformLocation(prog, "illumination")) == -1)
            std::cerr << "!!! pas trouvé la \"Location\" de illumination" << std::endl;
    }
    ...
    void afficherContenu(GLenum ordre = GL_CCW)
    {
        ...
        if (Etat::culling)
            glEnable(GL_CULL_FACE);
        if (Etat::culling)
            glCullFace(ordre == GL_CCW ? GL_BACK : GL_FRONT);
    ...
    void afficher()
    {
        ...
        // partie 1: modifs ici ...
        // ...
        // Il faut commencer par activer le test du stencil.
        glEnable(GL_STENCIL_TEST);
        // Puis, on lui dit de remplacer les valeurs.
        ...
        // Puis, on lui dit de conserver les valeurs.
        glStencilOp(GL_KEEP, GL_KEEP, GL_KEEP);

        // et on trace le contenu inverser 4 fois
        // Les regions a afficher:

        // Bon, ici, il y a de la repetition, mais ce n'est pas mentionner dans
        // l'enonce du TP2 qu'il fallait s'occuper des « Code Smells »

        // Les affichages

        glStencilFunc(GL_EQUAL, 1, 1); // Pour les Ypos.
        // Affichage contenu pour Ypos.
        matrModel.PushMatrix();
        {
        ...
        glStencilFunc(GL_EQUAL, 2, 2); // Pour les Xpos.
        // Affichage contenu pour Xpos.
        matrModel.PushMatrix();
        {
        ...
        glStencilFunc(GL_EQUAL, 4, 4); // Pour les Yneg.
        // Affichage contenu pour Yneg.
        matrModel.PushMatrix();
        {
            matrModel.Translate(0.0, -2 * Etat::bDim.y, 0.0);
            matrModel.Scale(-1, 1, 1);
        ...
        glStencilFunc(GL_EQUAL, 8, 8); // Pour les Xneg.
        // Affichage contenu pour Xneg.
        matrModel.PushMatrix();
        {
            matrModel.Translate(-2 * Etat::bDim.x, 0.0, 0.0);
            matrModel.Scale(1, -1, 1);
    ...
    void selectionnerTheiere()
    {
        ...
        std::cout << "couleur[0] : " << couleur[0] << std::endl;
