...
public:
    ...
    void afficher()
    {
        ...
        // Test pour les +X.
        glStencilFunc(GL_NEVER, 1, 2);
        afficherParoisXpos(); // paroi en +X

        // Test pour les -Y.
        glStencilFunc(GL_NEVER, 1, 4);
        afficherParoisYneg(); // paroi en -Y

        // Test pour les -X.
        glStencilFunc(GL_NEVER, 1, 8);
        afficherParoisXneg(); // paroi en -X
        ...
        glStencilFunc(GL_EQUAL, 1, 8);  // Pour les Xneg.
        glStencilFunc(GL_EQUAL, 1, 4);  // Pour les Yneg.
        glStencilFunc(GL_EQUAL, 1, 2);  // Pour les Xpos.
